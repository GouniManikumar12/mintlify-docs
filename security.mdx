...
For **RetrieveRequest** and **RetrieveResponse** (platform ↔ publisher, no ads), the normative signing scheme is defined in [AIP Authentication & Signing (v0.1)](/authentication-signing): required headers, canonical string, HMAC-SHA256, replay window, and verification rules.
