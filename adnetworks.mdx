...
Ad Networks run the AIP infrastructure that connects AI Platforms and Brand Agents.  
...
If successful, you will receive a `PlatformResponse` payload containing winner state, creative data, and optional delegation/tracking metadata.
