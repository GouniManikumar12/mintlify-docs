...
A **Platform** is any user-facing system that collects natural language intent and displays monetized recommendations returned through the Agentic Intent Protocol (AIP). Platforms act as the **publishers** within AIP.

Platforms do not interact with Brand Agents directly and do not implement auctions. All auction logic, scoring, and billing is handled by an AIP Operator.
...
- Score bids  
- Validate events  
- Communicate with Brand Agents  
- Manage advertiser budgets  
- Perform billing or attribution logic  

These responsibilities belong exclusively to the **Operator**.
