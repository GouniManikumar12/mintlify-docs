---
title: AIP State Machine
description: How AIP defines allowed state transitions from exposure and delegation through task completion, settlement, expiry, and refund handling.
---
