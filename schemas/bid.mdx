...
| `decision_phases` | array | Yes | Supported phases such as `consideration`, `decision`, or `post_purchase` |
...
`research`, `consideration`, `decision`, `post_purchase`, `unknown`
...
| `preferred_pricing_model` | string | No | Preferred billing model: `CPX`, `CPC`, or `CPA` |
