---
title: PAG Publisher Declaration (aip.json)
sidebarTitle: aip.json
description: Field-by-field documentation for the PAG publisher declaration at /.well-known/aip.json.
---
