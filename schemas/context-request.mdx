...
| `context_id` | string | Yes | Unique identifier for this operator-generated ContextRequest |
...
| Before | After | Why |
|--------|-------|-----|
| Single reused upstream request identifier | `context_id` + `source_request_id` | Separate operator-generated ID from upstream reference for clean traceability |
...
- [Platform Response](/schemas/platform-response) — The operator's auction outcome after evaluating bids
