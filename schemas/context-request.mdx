...
## Overview
Operator request distributed to subscribed brand agents after the AI platform submits a `platform_request`. It contains the normalized context, pricing constraints, and auth that bidders need to participate.
