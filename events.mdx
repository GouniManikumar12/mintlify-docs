...
**CPX (Exposure)** - Requires: `session_id`, `platform_id`, `agent_id`, `wallet_id`, `pricing`
**CPC (Click)** - Requires: `event_id`
**CPA (Conversion)** - Requires: `conversion_id`, `conversion_type`
