...
```json
{
  ...
  "verified_by": ["Platform", "AdNetwork"],
  "signature": "a8e3bf9d..."
}
```
...
sequenceDiagram
  ...
  Platform->>AdNetwork: Send EventPacket
  AdNetwork->>Ledger: Log verification + signature hash
  BrandAgent->>Ledger: Confirm event via callback
