...
PlatformRequest uses UCP (Universal Context Protocol) format with nested structure (spec_version, message_id, producer, context, identity, extensions). A PlatformRequest may include:
