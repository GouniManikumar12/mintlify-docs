...
Brand Agents submit `Bid` payloads to the Operator within the selection window.
...
At least one of `pricing.cpx_micros`, `pricing.cpc_micros`, or `pricing.cpa_micros` MUST be included for a valid bid.
