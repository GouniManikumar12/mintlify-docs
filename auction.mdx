...
# Auction and Scoring
AIP runs a short timed auction. When a platform sends a context_request, the Operator tags it into category pools and sends it only to Brand Agents subscribed to those pools. Delivery happens through a pub/sub system.
...
The Operator classifies the request into category pools and uses publish/subscribe transport to deliver it only to Brand Agents subscribed to those pools.
