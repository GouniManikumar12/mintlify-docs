...
- Matched with advertiser agents  
...
| **Real-Time Auction** | Lets advertiser agents bid on verified intent | Creates market-based pricing for intent |
...
sequenceDiagram
  ...
  participant AA as Advertiser Agents
...
- [Quickstart for Advertiser Agents](/quickstart-agent)  